...
Revision ID: 17ced9ea5bbf
Revises: c31403c47d0e
Create Date: 2022-12-01 16:06:04.033926
...
revision = '17ced9ea5bbf'
down_revision = 'c31403c47d0e'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['picture_id'], ['files.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
