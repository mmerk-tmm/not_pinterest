...
from backend.schemas.post import CreateComment, PostComment
...
def update_comment(comment_id: int, comment_data: CreateComment, Auth: Authenticate = Depends(Authenticate())):
